  ...
  return (
    <>
      ...
      <ListGroup className="text-center">
        ...
        <Link to="/numbers" className="list-group-item list-group-item-action">
          Sorteio de números
        </Link>
        <Link to="/shuffle" className="list-group-item list-group-item-action">
          Embaralhador de frases
        </Link>
        <Link
          to="/headortails"
          className="list-group-item list-group-item-action"
        ...
        <Link
          to="/logout"
          className="list-group-item list-group-item-action bg-danger text-light"
        >
          Sair da conta
        </Link>
      </ListGroup>
