...
const Numbers = () => {
  ...
  const isDrawAllowedIfNotWarnUser = () => {
    ...
    if (!quantity || !randMin || !randMax) {
      toastr.warning(
        'Atenção!',
        'Você precisa preencher os campos para efetuar um sorteio!',
      );
      isDrawAllowed = false;
    }
    ...
    if (
      ...
      toastr.warning(
        'Atenção!',
        'Os valores definidos não podem ser negativos ou maiores que 9999999',
      );
      isDrawAllowed = false;
    }
    ...
    if (quantity > randMax) {
      toastr.warning(
        'Atenção!',
        'A quantidade de números sorteados não pode ser maior que o valor máximo!',
      );
      isDrawAllowed = false;
    }
    ...
    if (quantity >= randMax - randMin) {
      toastr.warning(
        'Atenção!',
        'A quantidade de números sorteados não pode ser maior que o intervalo entre os valores mínimo e máximo!',
      );
      isDrawAllowed = false;
    }
  ...
  return (
    <Container>
      ...
      <If c={randNums.length > 0}>
        <DrawResults
          title="Os números sorteados foram:"
